  ...
  if (!resource)
    return (
      <Box>
        ...
        <Button mt="md" onClick={() => router.push('/setup/resources')}>
          Back to Resources
        </Button>
      </Box>
    );
  ...
  return (
    <Box>
      ...
      <Group justify="space-between" mb="md">
        ...
        <Button leftSection={<IconEdit size={16} />} variant="outline" onClick={handleEditResource}>
          Edit Resource
        </Button>
      </Group>
          ...
          <Table.Tbody>
            {resource.chapters.map((chapter) => (
              <Table.Tr
                ...
                onClick={() =>
                  router.push(`/setup/resources/${resource.id}/chapters/${chapter.id}`)
                }
              >
